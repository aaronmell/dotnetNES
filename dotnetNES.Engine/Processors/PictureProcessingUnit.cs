...
namespace dotnetNES.Engine.Processors
{
    ...
    internal class PictureProcessingUnit
    {
        ...
        private static readonly byte[] _pallet =
        {
         ...
         private static byte[] spriteMirror =
            {
        ...
        internal unsafe void DrawNametable(byte* nameTablePointer, int nameTableSelect)
        {
            ...
            for (var tableRow = 0; tableRow < 30; tableRow++)
            {
                ...
                for (var tableColumn = 0; tableColumn < 32; tableColumn++)
                {
                    ...
                    DrawTileToBitmapArray(nameTablePointer, 32, nameTableByte, _backgroundPatternTableAddressOffset, tableRow, tableColumn, attribute, false);
                    currentPosition++;
                }
            }
        }
        ...
        //private int _spritePosition;
        //private int _spriteSubPosition;
        //private int _objectAttributeMemoryByteAddress;
        ...
        private unsafe void DrawPatternTableToBitmapArray(byte* bitmapArray, bool fetchPattern0)
        {
            ...
            for (var row = 0; row < 16; row++)
            {
                 ...
                 {
                     DrawTileToBitmapArray(bitmapArray, 16, (row * 16) + column, fetchPattern0 ? 0 : 0x1000, row, column, 0, false);
                 }
            }
        }
        ...
        private unsafe void DrawTileToBitmapArray(byte* bitmapArray, int totalColumns, int tileAddress, int tileOffset, int row, int column, int paletteOffset, bool isSprite)
        {
